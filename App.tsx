  ...
  return (
    <div className="flex min-h-screen bg-[#FAF8F5] font-sans text-primary">
      ...
      <main className="ml-64 flex-1 h-screen overflow-y-auto flex flex-col">
        ...
        <footer className="bg-surface border-t border-gray-200 py-8 px-12 shrink-0">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
             
             {/* Left: Copyright & Essential Links */}
             <div className="flex flex-col md:flex-row items-center gap-2 md:gap-8 text-sm text-gray-500">
                <span className="font-serif text-primary font-medium">© 2025 Classic Homes</span>
                <div className="flex gap-6">
                  <a href="#" className="hover:text-accent transition-colors">Privacy Policy</a>
                  <a href="#" className="hover:text-accent transition-colors">Terms of Service</a>
                  <a href="#" className="hover:text-accent transition-colors">DMCA</a>
                  <a href="#" className="hover:text-accent transition-colors">Help Center</a>
                </div>
             </div>

             {/* Right: Socials & Payments */}
             <div className="flex flex-col md:flex-row items-center gap-6">
                
                {/* Social Icons */}
                <div className="flex items-center gap-4">
                   <a href="#" className="text-[#E1306C] hover:opacity-80 transition-opacity"><Instagram size={20} /></a>
                   <a href="#" className="text-[#0077b5] hover:opacity-80 transition-opacity"><Linkedin size={20} /></a>
                   <a href="#" className="text-[#1DA1F2] hover:opacity-80 transition-opacity"><Twitter size={20} /></a>
                   <a href="#" className="text-[#1877F2] hover:opacity-80 transition-opacity"><Facebook size={20} /></a>
                </div>
                ...
                <div className="flex items-center gap-3">
                   {/* Visa */}
                   <div className="h-8 w-12 bg-white border border-gray-200 rounded flex items-center justify-center p-1 shadow-sm">
                   ...
                   {/* USDC */}
                   <div className="h-8 w-12 bg-white border border-gray-200 rounded flex items-center justify-center p-1 shadow-sm">
                      <div className="h-5 w-5 rounded-full border border-[#2775CA] flex items-center justify-center text-[10px] text-[#2775CA] font-bold tracking-tighter">
                         $
                      </div>
                   </div>
                </div>
