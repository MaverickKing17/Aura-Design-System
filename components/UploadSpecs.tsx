...
export const UploadSpecs: React.FC<UploadSpecsProps> = ({ onNext }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in pb-12">
      <div className="mb-8">
        <h2 className="text-3xl font-serif text-primary mb-2">Initiate Sourcing</h2>
        <p className="text-gray-500">Upload technical specifications to begin AI-driven matchmaking.</p>
      </div>

      {/* Step 1: Context */}
      <div className="bg-surface p-8 shadow-luxury border-t-4 border-gray-200">
        <h3 className="text-lg font-bold text-primary mb-4 flex items-center">
          <span className="bg-primary text-white w-6 h-6 rounded-full flex items-center justify-center text-xs mr-3">1</span>
          Project Context
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Active Project</label>
            <div className="relative">
              <select 
                value={selectedProject}
                onChange={(e) => setSelectedProject(e.target.value)}
                className="w-full pl-4 pr-10 py-3 bg-gray-50 border border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary outline-none appearance-none font-medium text-primary"
              >
                {MOCK_PROJECTS.map(p => (
          ...
          <div>
             ...
             <select className="w-full px-4 py-3 bg-gray-50 border border-gray-300 focus:border-primary outline-none font-medium text-primary">
      ...
      <div className="bg-surface p-8 shadow-luxury border-t-4 border-gray-200">
        <h3 className="text-lg font-bold text-primary mb-4 flex items-center">
          <span className="bg-primary text-white w-6 h-6 rounded-full flex items-center justify-center text-xs mr-3">2</span>
        ...
        {!file ? (
          ...
          >
            ...
            <p className="text-lg font-medium text-primary mb-2">Drag & Drop Specifications</p>
            <p className="text-sm text-gray-500 mb-6">Supports PDF, CAD (.dwg), Revit (.rvt), IFC</p>
          ...
          <div className="border border-gray-200 rounded-lg p-6 bg-gray-50">
             ...
             <div className="space-y-3">
               ...
               {parsed && (
                 <div className="mt-4 bg-green-50 border border-green-200 p-4 rounded flex items-start">
